...
public class GazetteerReverseColoredQuadGuiElementRenderState implements GuiElementRenderState{
    ...
    public GazetteerReverseColoredQuadGuiElementRenderState(RenderPipeline pipeline, TextureSetup textureSetup, Matrix3x2f pose, int x0, int y0, int x1, int y1, int col1, int col2, @Nullable ScreenRectangle scissorArea){
