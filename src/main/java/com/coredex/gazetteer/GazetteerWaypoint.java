...
public class GazetteerWaypoint{
    public int x, y, z;
    public String name;
    ...
    GazetteerWaypoint(String coords, String waypointName, String waypointDimension, boolean isRendered, boolean isDeathpoint){
        String s = coords;
        s = s.replace("X", "");
        s = s.replace("Y", "");
        s = s.replace("Z", "");
    ...
    GazetteerWaypoint(int x, int y, int z, String waypointName, String waypointDimension, boolean isRendered, boolean isDeathpoint){
        this.x = x;
        this.y = y;
        this.z = z;
        this.name = waypointName;
